...
import com.cd.model.WatiParameters;
import com.cd.model.WatiRequest;
...
public class WatiServiceImpl implements WatiService{
	...
	public WatiResponse sendDeliveryNotification(String phno,String name, String orderTrackingNumber){
        ...
        requestDTO.setTemplete_name(watiNotificationTemplateName);
	...
	public WatiResponse sendPaymentRemainder(String phno,String name, String orderTrackingNumber){
        ...
        WatiRequest requestDTO = new WatiRequest();
        requestDTO.setTemplete_name(watiPaymentReminderTemplateName);
